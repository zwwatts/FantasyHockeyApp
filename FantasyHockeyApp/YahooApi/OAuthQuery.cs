...
namespace YahooApi
{
    public class OAuthQuery
    {
        ...
        public string MakeCallToBossGeoApi()
        {
            string result;
            const string key = "dj0yJmk9UllsVmE4SU85MjU5JmQ9WVdrOVJWWlljR2xWTldFbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD05Nw--";
            const string secret = "0b1cea68d321de2735b00a28ea8c8bedad84589f";
            var oauthToken2 = "A%3D.I_P76GdjxCta9O4gBQ8_No3hds69b_gHSbNrcsghhkQcb1ZctHokldwrUaDUixFqo4bdhbR1G4P.0pa9qmcWECl5h5tw03t3WvQpKM2NXYuw08qiLpYnhcRKLNrTmKH30SXbGP0VHBWxOmCixBppDmc4OcmOIZSPYYS.MQYYFUoO77FuwhIOatqYB.iX4OoovXvuIjqIu5YuranxChfoZKbXV3vsNY_LiwOObabBnEfOgwYB3f3h6Qlrxve67wQlQWqAE0T_mSsB4YM6Ol77_DPMteyedJVZrtYogczcKLTihf0XR_qUGohDb28EziVer0VSe2r63EfJ2Q6JOmB4PaVEAE9dqb3Ckh3vF.CwYL9i2zwfUiXNNjR7aHjj8odnvi3PNlZjiQpXhbS1ZECkfnz3n9SSJ5fp7jLx9eo.GQhuA1Kmf0gNbK4IamTS1Utm1DM030No1PLS_8lz5u8E_.EsgMK.jeF3kUlRUihllGXE_KveX6pgooeWqyXCILet96gtOzL.eFVmgGasAX90mnbn_5oC7_0My8Wyag0YiHtrkD1g0umjjep_qMsr4zNcDBU9JfIG0j2H0hTbaE5daVjUdZLFsSctgww.Xx2QS1IczqPBsi0gdGlrZYjcilRbxKjLMTuvBPpmUwmjXcBFZK7bwv5HWwSdJ_vgXsGqHpQvTvThldEA7hNsuwbtcPoJY_hS5PUv_tggwkU1xzbiCia.46t7JX0Y2BbuEhoA.QuPAOCbL3AbDKonLV8D8v__bjNOnPkch44Z4cegBBWJnpLUT.e1EGHJ6rI7cbAJAoLsn66U5hX";
            var oauthSecret2 = "9df23378b281b7094de2771b7ff94b5ada0a48e9";
            var uri = new Uri(@"http://fantasysports.yahooapis.com/fantasy/v2/game/nhl");
            var o = new OAuthBase();
            string nonce = o.GenerateNonce();
            var timestamp = o.GenerateTimeStamp();
            ...
            string signature = HttpUtility.UrlEncode(
                o.GenerateSignature(uri,
                                    key,
                                    secret, oauthToken2, oauthSecret2, "GET",
                                    timestamp, nonce, out normalizedUrl,
                                    out normalizedParameters));
            ...
            using (var httpClient = new WebClient())
            {
                result = httpClient.DownloadString(new Uri("http://api.search.yahoo.com/WebSearchService/V1/webSearch?appid=YahooDemo&query=umbrella&results=10"));
            }
